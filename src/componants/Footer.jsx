...
const Footer = () => {
    return (
            ...
            <footer className="bg-gray-800 mt-40 text-white dark:bg-gray-900">
                <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                    ...
                    <div className="sm:flex sm:items-center sm:justify-between">
                        ...
                        <div className="flex mt-4 sm:justify-center sm:mt-0">
                            ...
                            <a href="#" className="text-gray-200 hover:text-indigo-600 dark:hover:text-white ms-5">
                            ...
                            <a href="#" className=" text-gray-200 hover:text-blue-400 dark:hover:text-white ms-5">
                            ...
                            <a href="#" className="text-white hover:text-gray-400 dark:hover:text-white ms-5">
                            ...
                            <a href="#" className="text-gray-200 hover:text-amber-700 dark:hover:text-white ms-5">
                                <svg className="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                                ...
                                <span className="bg-red-600 sr-only">Dribbble account</span>
                            </a>
                        </div>
                    </div>
                </div>
