...
const ALLproducts = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // console.log(data)
    axios.post(`https://b9a12-server-side-safwan169.vercel.app/alldataTags`, dd).then((res) => {
    ...
    <div className="mt-10  ">
      ...
      <div className="join text-center  w-full flex justify-center mt-14">
        {peg.map((d, index) => (
          ...
          //     className={({ isActive }) =>
          //       isActive
          //         ? "text-blue-500 border-b-2 border-blue-600  py-3  transition duration-300 ease-in-out "
          ...
          <button
            ...
            className={`border px-4 py-2 border-gray-500 ${
              pagination == index ? "bg-blue-500 text-white" : "text-black"
            } mr-2   rounded-none`}
          >
            {d + 1}
          </button>
